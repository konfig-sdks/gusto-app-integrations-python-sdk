...
class RequiredCompaniesCreateCompanyRequestUser(TypedDict):
...
class OptionalCompaniesCreateCompanyRequestUser(TypedDict, total=False):
    # The phone number of the user who will be the primary payroll admin.
    phone: str

class CompaniesCreateCompanyRequestUser(RequiredCompaniesCreateCompanyRequestUser, OptionalCompaniesCreateCompanyRequestUser):
    pass
