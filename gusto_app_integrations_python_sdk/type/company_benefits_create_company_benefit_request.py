...
class RequiredCompanyBenefitsCreateCompanyBenefitRequest(TypedDict):
...
class OptionalCompanyBenefitsCreateCompanyBenefitRequest(TypedDict, total=False):
...
class CompanyBenefitsCreateCompanyBenefitRequest(RequiredCompanyBenefitsCreateCompanyBenefitRequest, OptionalCompanyBenefitsCreateCompanyBenefitRequest):
    pass
