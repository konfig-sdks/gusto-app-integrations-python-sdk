...
class RequiredEmployeeBenefitsCreateBenefitRequestContribution(TypedDict):
    pass

class OptionalEmployeeBenefitsCreateBenefitRequestContribution(TypedDict, total=False):
    ...
    value: typing.Union[str, typing.List[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]]

class EmployeeBenefitsCreateBenefitRequestContribution(RequiredEmployeeBenefitsCreateBenefitRequestContribution, OptionalEmployeeBenefitsCreateBenefitRequestContribution):
    pass
