...
from gusto_app_integrations_python_sdk.type.payroll_totals_type import PayrollTotalsType
from gusto_app_integrations_python_sdk.type.payroll_withholding_pay_period_type import PayrollWithholdingPayPeriodType

class RequiredPayrollMinimal(TypedDict):
    pass

class OptionalPayrollMinimal(TypedDict, total=False):
...
class PayrollMinimal(RequiredPayrollMinimal, OptionalPayrollMinimal):
    pass
