...
class RequiredEmployeeBenefitsCreateBenefitRequest(TypedDict):
    # The UUID of the company benefit.
    company_benefit_uuid: str

class OptionalEmployeeBenefitsCreateBenefitRequest(TypedDict, total=False):
...
class EmployeeBenefitsCreateBenefitRequest(RequiredEmployeeBenefitsCreateBenefitRequest, OptionalEmployeeBenefitsCreateBenefitRequest):
    pass
