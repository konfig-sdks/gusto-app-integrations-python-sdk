...
from gusto_app_integrations_python_sdk.model.employee import Employee as EmployeeSchema
...
from gusto_app_integrations_python_sdk.model.employees_update_employee_request import EmployeesUpdateEmployeeRequest as EmployeesUpdateEmployeeRequestSchema

from gusto_app_integrations_python_sdk.type.unprocessable_entity_error_object import UnprocessableEntityErrorObject
from gusto_app_integrations_python_sdk.type.employees_update_employee_request import EmployeesUpdateEmployeeRequest
from gusto_app_integrations_python_sdk.type.employee import Employee
...
from gusto_app_integrations_python_sdk.pydantic.employees_update_employee_request import EmployeesUpdateEmployeeRequest as EmployeesUpdateEmployeeRequestPydantic
from gusto_app_integrations_python_sdk.pydantic.employee import Employee as EmployeePydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeesUpdateEmployeeRequestSchema


request_body_employees_update_employee_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_employee_mapped_args(
        self,
        version: str,
        employee_id: str,
    ...
    async def _aupdate_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employee_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_employees_update_employee_request.serialize(body, content_type)
...
class UpdateEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_employee(
        self,
        version: str,
        employee_id: str,
        first_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_employee_mapped_args(
            version=version,
        ...
        return await self._aupdate_employee_oapg(
            body=args.body,
...
class UpdateEmployee(BaseApi):
    ...
    async def aupdate_employee(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_employee(
            version=version,
            employee_id=employee_id,
            first_name=first_name,
            middle_initial=middle_initial,
    ...
    def update_employee(
        ...
        raw_response = self.raw.update_employee(
            version=version,
            employee_id=employee_id,
            first_name=first_name,
            middle_initial=middle_initial,
