...
from gusto_app_integrations_python_sdk.model.events_get_all_response import EventsGetAllResponse as EventsGetAllResponseSchema

from gusto_app_integrations_python_sdk.type.events_get_all_response import EventsGetAllResponse

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.events_get_all_response import EventsGetAllResponse as EventsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EventsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EventsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[EventsGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(EventsGetAllResponsePydantic, raw_response.body)
