...
from gusto_app_integrations_python_sdk.model.pay_schedule import PaySchedule as PayScheduleSchema

from gusto_app_integrations_python_sdk.type.pay_schedule import PaySchedule

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.pay_schedule import PaySchedule as PaySchedulePydantic
...
PayScheduleIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'company_id': typing.Union[CompanyIdSchema, str, ],
        'pay_schedule_id': typing.Union[PayScheduleIdSchema, str, ],
    }
)
...
request_path_pay_schedule_id = api_client.PathParameter(
    name="pay_schedule_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PayScheduleIdSchema,
    required=True,
)
_auth = [
    'Authorization',
]
SchemaFor200ResponseBodyApplicationJson = PayScheduleSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_details_mapped_args(
        ...
        if pay_schedule_id is not None:
            _path_params["pay_schedule_id"] = pay_schedule_id
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/pay_schedules/{pay_schedule_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return PaySchedulePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaySchedulePydantic, raw_response.body)
