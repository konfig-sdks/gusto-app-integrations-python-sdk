...
from gusto_app_integrations_python_sdk.model.pay_schedules_list_response import PaySchedulesListResponse as PaySchedulesListResponseSchema

from gusto_app_integrations_python_sdk.type.pay_schedules_list_response import PaySchedulesListResponse

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.pay_schedules_list_response import PaySchedulesListResponse as PaySchedulesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PaySchedulesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaySchedulesListResponse
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/pay_schedules',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaySchedulesListResponsePydantic:
        ...
        if validate:
            return RootModel[PaySchedulesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PaySchedulesListResponsePydantic, raw_response.body)
