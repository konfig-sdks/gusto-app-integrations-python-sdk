...
class BaseApi(api_client.Api):
    ...
    def _delete_termination_mapped_args(
        self,
        employee_id: str,
    ...
    async def _adelete_termination_oapg(
        self,
...
class DeleteTerminationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_termination(
        self,
        employee_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_termination_mapped_args(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._adelete_termination_oapg(
    ...
    def delete_termination(
        ...
        return self._delete_termination_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteTermination(BaseApi):
    ...
    async def adelete_termination(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_termination(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
        )
    ...
    def delete_termination(
        ...
        raw_response = self.raw.delete_termination(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
