...
from gusto_app_integrations_python_sdk.model.contractors_get_all_response import ContractorsGetAllResponse as ContractorsGetAllResponseSchema

from gusto_app_integrations_python_sdk.type.contractors_get_all_response import ContractorsGetAllResponse

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.contractors_get_all_response import ContractorsGetAllResponse as ContractorsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContractorsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContractorsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContractorsGetAllResponsePydantic:
        ...
        if validate:
            return RootModel[ContractorsGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContractorsGetAllResponsePydantic, raw_response.body)
