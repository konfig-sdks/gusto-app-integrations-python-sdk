...
class BaseApi(api_client.Api):
    ...
    def _get_rehire_info_mapped_args(
        self,
        employee_id: str,
    ...
    async def _aget_rehire_info_oapg(
        self,
...
class GetRehireInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rehire_info(
        self,
        employee_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_rehire_info_mapped_args(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aget_rehire_info_oapg(
    ...
    def get_rehire_info(
        ...
        return self._get_rehire_info_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetRehireInfo(BaseApi):
    ...
    async def aget_rehire_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_rehire_info(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
        )
    ...
    def get_rehire_info(
        ...
        raw_response = self.raw.get_rehire_info(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        if validate:
