...
from gusto_app_integrations_python_sdk.model.benefit_summary import BenefitSummary as BenefitSummarySchema

from gusto_app_integrations_python_sdk.type.benefit_summary import BenefitSummary

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.benefit_summary import BenefitSummary as BenefitSummaryPydantic
...
SchemaFor200ResponseBodyApplicationJson = BenefitSummarySchema
...
class BaseApi(api_client.Api):
    ...
    def _get_summary_by_id_mapped_args(
        self,
    ...
    async def _aget_summary_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/company_benefits/{company_benefit_id}/summary',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSummaryByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_summary_by_id(
        self,
        company_benefit_id: str,
        start_date: typing.Optional[str] = None,
        end_date: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_summary_by_id_mapped_args(
        ...
        return await self._aget_summary_by_id_oapg(
    ...
    def get_summary_by_id(
        ...
        return self._get_summary_by_id_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GetSummaryById(BaseApi):
    ...
    async def aget_summary_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BenefitSummaryPydantic:
        raw_response = await self.raw.aget_summary_by_id(
            company_benefit_id=company_benefit_id,
            start_date=start_date,
            end_date=end_date,
            detailed=detailed,
        ...
        if validate:
            return BenefitSummaryPydantic(**raw_response.body)
        return api_client.construct_model_instance(BenefitSummaryPydantic, raw_response.body)
    ...
    def get_summary_by_id(
        ...
        raw_response = self.raw.get_summary_by_id(
            company_benefit_id=company_benefit_id,
            start_date=start_date,
            end_date=end_date,
            detailed=detailed,
