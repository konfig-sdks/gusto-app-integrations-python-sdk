...
class BaseApi(api_client.Api):
    ...
    def _prepare_for_update_mapped_args(
        self,
        company_id: str,
        payroll_id: str,
    ...
    async def _aprepare_for_update_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/payrolls/{payroll_id}/prepare',
            auth_settings=_auth,
            headers=_headers,
        )
...
class PrepareForUpdateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprepare_for_update(
        self,
        company_id: str,
        payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._prepare_for_update_mapped_args(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aprepare_for_update_oapg(
    ...
    def prepare_for_update(
        ...
        return self._prepare_for_update_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PrepareForUpdate(BaseApi):
    ...
    async def aprepare_for_update(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aprepare_for_update(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
    ...
    def prepare_for_update(
        ...
        raw_response = self.raw.prepare_for_update(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
