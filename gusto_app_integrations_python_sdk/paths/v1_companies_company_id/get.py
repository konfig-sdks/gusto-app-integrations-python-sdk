...
from gusto_app_integrations_python_sdk.model.company import Company as CompanySchema

from gusto_app_integrations_python_sdk.type.company import Company

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.company import Company as CompanyPydantic
...
SchemaFor200ResponseBodyApplicationJson = CompanySchema
...
class BaseApi(api_client.Api):
    ...
    def _get_company_info_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_company_info_oapg(
        self,
...
class GetCompanyInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_company_info(
        self,
        company_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_company_info_mapped_args(
            company_id=company_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aget_company_info_oapg(
    ...
    def get_company_info(
        ...
        return self._get_company_info_oapg(
            header_params=args.header,
            path_params=args.path,
        )
...
class GetCompanyInfo(BaseApi):
    ...
    async def aget_company_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_company_info(
            company_id=company_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
        )
        if validate:
            return CompanyPydantic(**raw_response.body)
        return api_client.construct_model_instance(CompanyPydantic, raw_response.body)
    ...
    def get_company_info(
        ...
        raw_response = self.raw.get_company_info(
            company_id=company_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        if validate:
