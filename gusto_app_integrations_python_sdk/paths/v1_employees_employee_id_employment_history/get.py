...
from gusto_app_integrations_python_sdk.model.employee_employments_get_history_response import EmployeeEmploymentsGetHistoryResponse as EmployeeEmploymentsGetHistoryResponseSchema

from gusto_app_integrations_python_sdk.type.employee_employments_get_history_response import EmployeeEmploymentsGetHistoryResponse

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.employee_employments_get_history_response import EmployeeEmploymentsGetHistoryResponse as EmployeeEmploymentsGetHistoryResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeEmploymentsGetHistoryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeEmploymentsGetHistoryResponse
    ...
    async def _aget_history_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employee_id}/employment_history',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetHistory(BaseApi):
    ...
    async def aget_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeEmploymentsGetHistoryResponsePydantic:
        ...
        if validate:
            return RootModel[EmployeeEmploymentsGetHistoryResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(EmployeeEmploymentsGetHistoryResponsePydantic, raw_response.body)
