...
from gusto_app_integrations_python_sdk.model.payroll import Payroll as PayrollSchema

from gusto_app_integrations_python_sdk.type.payroll import Payroll

from ...api_client import Dictionary
from gusto_app_integrations_python_sdk.pydantic.payroll import Payroll as PayrollPydantic
...
SchemaFor200ResponseBodyApplicationJson = PayrollSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_single_payroll_mapped_args(
        self,
        company_id: str,
        payroll_id: str,
    ...
    async def _aget_single_payroll_oapg(
        self,
...
class GetSinglePayrollRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_payroll(
        self,
        company_id: str,
        payroll_id: str,
        include: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_single_payroll_mapped_args(
            company_id=company_id,
            payroll_id=payroll_id,
            include=include,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aget_single_payroll_oapg(
    ...
    def get_single_payroll(
        ...
        return self._get_single_payroll_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GetSinglePayroll(BaseApi):
    ...
    async def aget_single_payroll(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_payroll(
            company_id=company_id,
            payroll_id=payroll_id,
            include=include,
            x_gusto_api_version=x_gusto_api_version,
        ...
        if validate:
            return PayrollPydantic(**raw_response.body)
        return api_client.construct_model_instance(PayrollPydantic, raw_response.body)
    ...
    def get_single_payroll(
        ...
        raw_response = self.raw.get_single_payroll(
            company_id=company_id,
            payroll_id=payroll_id,
            include=include,
            x_gusto_api_version=x_gusto_api_version,
