...
class EmployeeAddressesUpdateHomeAddressRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "street_1", "street_2", "city", "state", "zip", "effective_date", "courtesy_withholding", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "street_1", "street_2", "city", "state", "zip", "effective_date", "courtesy_withholding", ], str]):
