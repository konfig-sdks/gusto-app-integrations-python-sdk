...
class PaymentMethodBankAccount(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["split_amount"]) -> MetaOapg.properties.split_amount: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "name", "hidden_account_number", "priority", "split_amount", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["split_amount"]) -> typing.Union[MetaOapg.properties.split_amount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "name", "hidden_account_number", "priority", "split_amount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        split_amount: typing.Union[MetaOapg.properties.split_amount, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
