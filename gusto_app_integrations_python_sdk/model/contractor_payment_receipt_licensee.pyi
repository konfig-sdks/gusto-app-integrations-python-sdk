...
class ContractorPaymentReceiptLicensee(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "address", "city", "state", "postal_code", "phone_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "address", "city", "state", "postal_code", "phone_number", ], str]):
