...
class PayrollsUpdateByIdRequestEmployeeCompensationsItemHourlyCompensationsItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'PayrollsUpdateByIdRequestEmployeeCompensationsItemHourlyCompensationsItem':
