...
class JobsAndCompensationsCreateJobRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "hire_date", "two_percent_shareholder", "state_wc_covered", "state_wc_class_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "hire_date", "two_percent_shareholder", "state_wc_covered", "state_wc_class_code", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        hire_date: typing.Union[MetaOapg.properties.hire_date, str, ],
