...
class ContractorOnboardingStatusOnboardingStepsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def requirements() -> typing.Type['ContractorOnboardingStatusOnboardingStepsItemRequirements']:
                return ContractorOnboardingStatusOnboardingStepsItemRequirements
            __annotations__ = {
                "title": title,
                "id": id,
                "required": required,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["requirements"]) -> 'ContractorOnboardingStatusOnboardingStepsItemRequirements': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["requirements"]) -> typing.Union['ContractorOnboardingStatusOnboardingStepsItemRequirements', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        requirements: typing.Union['ContractorOnboardingStatusOnboardingStepsItemRequirements', schemas.Unset] = schemas.unset,
