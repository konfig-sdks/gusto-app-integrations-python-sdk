...
class CompanyPrimarySignatoryHomeAddress(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["street_1", "street_2", "city", "state", "zip", "country", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["street_1", "street_2", "city", "state", "zip", "country", ], str]):
