...
class FormPdf(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "document_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "document_url", ], str]):
