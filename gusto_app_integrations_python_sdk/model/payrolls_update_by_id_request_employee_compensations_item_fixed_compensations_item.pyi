...
class PayrollsUpdateByIdRequestEmployeeCompensationsItemFixedCompensationsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "amount", "job_uuid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "amount", "job_uuid", ], str]):
    ...
    ) -> 'PayrollsUpdateByIdRequestEmployeeCompensationsItemFixedCompensationsItem':
