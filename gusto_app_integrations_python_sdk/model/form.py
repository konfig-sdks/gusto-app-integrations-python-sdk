...
class Form(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "uuid", "name", "draft", "year", "quarter", "requires_signing", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "uuid", "name", "draft", "year", "quarter", "requires_signing", ], str]):
