...
class EmployeeAddressesCreateWorkAddressRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["location_uuid", "effective_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["location_uuid", "effective_date", ], str]):
