...
class PayrollPayPeriodType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["start_date", "end_date", "pay_schedule_uuid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["start_date", "end_date", "pay_schedule_uuid", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pay_schedule_uuid: typing.Union[MetaOapg.properties.pay_schedule_uuid, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
