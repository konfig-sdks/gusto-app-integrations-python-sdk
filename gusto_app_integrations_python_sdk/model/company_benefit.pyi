...
class CompanyBenefit(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "version", "uuid", "benefit_type", "active", "deletable", "supports_percentage_amounts", "responsible_for_employer_taxes", "responsible_for_employee_w2", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "version", "uuid", "benefit_type", "active", "deletable", "supports_percentage_amounts", "responsible_for_employer_taxes", "responsible_for_employee_w2", ], str]):
