...
class Garnishment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "version", "uuid", "employee_uuid", "active", "amount", "court_ordered", "times", "recurring", "annual_maximum", "pay_period_maximum", "deduct_as_percentage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "version", "uuid", "employee_uuid", "active", "amount", "court_ordered", "times", "recurring", "annual_maximum", "pay_period_maximum", "deduct_as_percentage", ], str]):
