...
from gusto_app_integrations_python_sdk.pydantic.employee_benefit_contribution import EmployeeBenefitContribution
...
class EmployeeBenefit(BaseModel):
    ...
    contribution: typing.Optional[EmployeeBenefitContribution] = Field(None, alias='contribution')
    ...
    retirement_loan_identifier: typing.Optional[str] = Field(None, alias='retirement_loan_identifier')
