...
from gusto_app_integrations_python_sdk.pydantic.contractor_payment import ContractorPayment

class ContractorPaymentSummaryByDatesContractorPaymentsItem(BaseModel):
