...
from gusto_app_integrations_python_sdk.pydantic.employee_benefits_update_benefit_request_contribution import EmployeeBenefitsUpdateBenefitRequestContribution

class EmployeeBenefitsUpdateBenefitRequest(BaseModel):
    ...
    contribution: typing.Optional[EmployeeBenefitsUpdateBenefitRequestContribution] = Field(None, alias='contribution')
