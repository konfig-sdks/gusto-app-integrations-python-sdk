...
from gusto_app_integrations_python_sdk.pydantic.tax_requirement_metadata_options import TaxRequirementMetadataOptions
from gusto_app_integrations_python_sdk.pydantic.tax_requirement_metadata_validation import TaxRequirementMetadataValidation
...
class TaxRequirementMetadata(BaseModel):
    ...
    type: Literal["text", "currency", "radio", "select", "percent", "account_number", "tax_rate", "workers_compensation_rate"] = Field(alias='type')

    options: typing.Optional[TaxRequirementMetadataOptions] = Field(None, alias='options')

    # [for `workers_compensation_rate`] The industry risk class code for the rate being requested
    risk_class_code: typing.Optional[str] = Field(None, alias='risk_class_code')

    # [for `workers_compensation_rate`] A description of the industry risk class for the rate being requested
    risk_class_description: typing.Optional[str] = Field(None, alias='risk_class_description')
    ...
    rate_type: typing.Optional[Literal["percent", "currency_per_hour"]] = Field(None, alias='rate_type')
    ...
    validation: typing.Optional[TaxRequirementMetadataValidation] = Field(None, alias='validation')
