...
class EmployeeBenefitsCreateBenefitRequestContribution(BaseModel):
    ...
    type: typing.Optional[Literal["tiered", "percentage", "amount"]] = Field(None, alias='type')
    ...
    value: typing.Optional[typing.Union[str, typing.List[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]]] = Field(None, alias='value')
